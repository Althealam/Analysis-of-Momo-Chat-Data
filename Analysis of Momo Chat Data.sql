...
--加载数据到表中
load data local inpath '/Users/linjiaxi/Desktop/Recommendation System /Hive/06_Hadoop生态综合案例：陌陌聊天数据分析/2、课程资料/陌陌聊天数据/data1.tsv' into table db_msg.tb_msg_source;
load data local inpath '/Users/linjiaxi/Desktop/Recommendation System /Hive/06_Hadoop生态综合案例：陌陌聊天数据分析/2、课程资料/陌陌聊天数据/data2.tsv' into table db_msg.tb_msg_source;
